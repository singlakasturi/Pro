...
//         <Route path="/contest-questions/:code" element={<ContestQuestions />} />
//         <Route path="/leaderboard/:contestCode/:questionNumber" element={<Leaderboard />}/>
//       </Routes>
//     </Router>
//   )
// }
...
function Home() {
  return (
    <>
      <section id="main" className="Main">
        <nav className="fixed top-6 left-0 right-0 z-50 flex justify-center cursor-pointer">
          <div className="bg-black/60 rounded-lg py-2.5 px-8 max-w-4xl w-full mx-auto flex justify-between items-center shadow-lg backdrop-blur-sm">
            ...
            <div className="hidden md:flex items-center space-x-10">
              <button className="text-white hover:text-gray-300 transition-colors">Why Us</button>
              <button className="text-white hover:text-gray-300 transition-colors">Mission</button>
              <button className="text-white hover:text-gray-300 transition-colors">FAQ</button>
        ...
        <div className="w-full h-screen flex items-center justify-center">
          <div className="max-w-7xl px-6 pt-32 flex flex-col items-center relative -mt-7">
            ...
            <div className="text-center relative z-10">
              ...
              <div className="mt-12 opacity-style">
                <Link to="/contests" className="inline-flex items-center justify-center gap-2 h-10 bg-[#1e1e1e] border border-[#333] text-white py-5 px-6 rounded-md text-base cursor-pointer">
                  Explore Contests ↓
                </Link>
              </div>
            </div>
      ...
      {/* Why / mission / contact sections copied as-is from your original — omitted here for brevity in the editor */}
      <FAQSection />
    </>
  );
}
